...
def generate_tripfile(incoming_link,outcoming_link,demand_per_od):
    ...
    #修改换道属性在vType里面
    for s in range(1):
        filename=(f'df/trip_0{df_text}.trip.xml')
        # filename=(f'SV_pr/trip_{p_text}.trip.xml')
...
#duarouter --route-files=trip_060.trip.xml --net-file=5x5.net.xml --output-file=Demand_060.rou.xml --randomize-flows true --departspeed 10 --weights.random-factor 1.5 --seed 30
