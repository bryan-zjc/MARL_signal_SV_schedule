# -*- coding: utf-8 -*-
"""
Created on Sat Feb 15 09:46:54 2025
...
class Intersec_Env:
    ...
    def reset(self,RV_schedule, save_path, episode):
        ...
        RV_states = {}
        for tls_id in self.net_info.keys():
            RV_states[tls_id] = self._get_state(tls_id, RV_schedule)
        # states = np.stack(states)

        return RV_states, self.net_info
    ...
    def step(self, action, RV_schedule):
        ...
        return RV_states, rewards, dones, self.next_decision_flag, self.travel_t
